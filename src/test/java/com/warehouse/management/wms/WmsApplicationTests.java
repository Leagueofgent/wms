...
//                            .addInclude("") // 设置需要生成的表名，不设置表名即为生成该数据库中所有的表
                            ...
                            .entityBuilder().enableRemoveIsPrefix()  //去掉布尔值的is_前缀
                            .enableLombok() //开启lombok模型

                            .controllerBuilder().enableRestStyle()  //restful 所有controller都是RestController
                            .serviceBuilder().formatServiceFileName("%sService"); //去掉Service接口的首字母I
                })
