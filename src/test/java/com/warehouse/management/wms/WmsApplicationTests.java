...
//                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D://")); // 设置mapperXml生成路径
                ...
                .strategyConfig(builder -> {
                    builder
                            .addInclude("permission") // 设置需要生成的表名，不设置表名即为生成该数据库中所有的表
                            ...
                            .mapperBuilder().superClass(BaseMapper.class).mapperAnnotation(org.apache.ibatis.annotations.Mapper.class).enableFileOverride()
